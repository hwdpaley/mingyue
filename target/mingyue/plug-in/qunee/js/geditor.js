...
var i18n = {"zh-cn": {Name: "名称", "Render Color": "渲染色", Border: "边框", "Border Color": "边框颜色", Location: "坐标", Size: "尺寸", Rotate: "旋转", "Label Color": "文本颜色", "Background Color": "背景色", "Font Size": "字体大小", "json file is empty": "JSON文件为空", "Save Error": "保存错误", "Save Success": "保存成功", Update: "更新", Submit: "提交", "Export JSON": "导出JSON", "Load File ...": "加载文件 ...", "Download File": "下载文件", Save: "保存", Rename: "重命名", "Input Element Name": "输入图元名称", "Solid Line": "实线样式", "Dashed Line": "虚线样式", "Line Width": "连线宽度", "Input Line Width": "输入连线宽度", "Line Color": "连线颜色", "Input Line Color": "输入连线颜色", "Out of Group": "脱离分组", "Send to Top": "置顶显示", "Send to Bottom": "置底显示", "Reset Layer": "恢复默认层", "Clear Graph": "清空画布", "Zoom In": "放大", "Zoom Out": "缩小", "1:1": "1:1", "Pan Mode": "平移模式", "Rectangle Select": "框选模式", Text: "文字", "Basic Nodes": "基本节点", "Register Images": "注册图片", "Default Shapes": "默认形状"}}, lang = navigator.language.toLowerCase();
!function (t, e) {
    var n = function (t) {
        t = t || {};
    ...
    var r = "draginfo", a = /MSIE 9/i.test(navigator.userAgent) || /MSIE 10/i.test(navigator.userAgent), s = !a;
    if (!s) {
        var l = {}, h = function (t) {
            return{x: t.pageX, y: t.pageY}
        }, u = document.documentElement, d = function () {
            u.addEventListener("mousemove", function (e) {
                if (l.target) {
                    ...
                    if (!l.dragElement) {
                        ...
                        var a = {target: i};
                        i.ondragstart instanceof Function && (l.dataTransfer = a.dataTransfer = {datas: {}, setData: function (t, e) {
                            this.datas[t] = e
                        }, getData: function (t) {
                            return this.datas[t]
                        }}, i.ondragstart(a))
            ...
            var e = p(t), n = e.x + t.scrollLeft, i = e.y + t.scrollTop, o = t.clientWidth, r = t.clientHeight;
    ...
    var e = e || "undefined" != typeof navigator && navigator.msSaveOrOpenBlob && navigator.msSaveOrOpenBlob.bind(navigator) || function (t) {
        ...
        if ("undefined" == typeof navigator || !/MSIE [1-9]\./.test(navigator.userAgent)) {
            var e = t.document, n = function () {
            ...
            }, h = "application/octet-stream", u = 0, d = 500, c = function (e) {
                var i = function () {
                ...
                var d, f, g, m = this, v = e.type, _ = !1, y = function () {
                    p(m, "writestart progress write writeend".split(" "))
                }, b = function () {
                    if ((_ || !d) && (d = n().createObjectURL(e)), f)f.location.href = d; else {
    ...
    function d(t, e) {
        var n = new u, o = {version: "2.0", refs: {}}, r = [], a = {};
    ...
    if (!t.Graph.prototype.parseJSON) {
        n.prototype = {_refs: null, _index: 1, root: null, reset: function () {
        ...
        var f = {"class": !1, id: !1, fillGradient: !1, syncSelectionStyles: !1, originalBounds: !1, parent: !1, font: !1, $data: !1, $x: !1, $y: !1};
        t.BaseUI.prototype.toJSON = function (t) {
            ...
            var e = {}, n = ["enableSubNetwork", "zIndex", "tooltipType", "tooltip", "movable", "selectable", "resizable", "uiClass", "name", "parent", "host"];
        ...
        }, u.prototype = {_refs: null, _refValues: null, _index: 1, root: null, reset: function () {
            ...
            if (e._className) {
                ...
                if (this.withGlobalRefs && void 0 !== e._refId && (this._refs[e._refId] = i), i && e.json)if (e = e.json, i.parseJSON)i.parseJSON(e, this); else for (var r in e)i[r] = e[r];
                return i
            }
            if (t.isArray(e)) {
                var a = [];
    ...
    function i() {
        ...
        var n = this._getChild(".graph-export-panel__export_scale"), i = this._getChild(".graph-export-panel__export_scale_label");
        n.onchange = function () {
    ...
    n.prototype = {destroy: function () {
    ...
    }}, Object.defineProperties(n.prototype, {bounds: {get: function () {
        return this._bounds
    }, set: function (t) {
        this._setBounds(t)
    }}}), i.prototype = {canvas: null, html: null, exportImageInfo: function (e) {
        var e = this.graph;
        if (e) {
            var n = this.export_scale.value, i = this.imageInfo.scale, o = new t.Rect(this.clipBounds.x / i, this.clipBounds.y / i, this.clipBounds.width / i, this.clipBounds.height / i);
        ...
        this.updateOutputSize = function () {
            var t = this._getChild(".graph-export-panel__export_scale"), e = t.value, n = o.width / this.imageInfo.scale * e | 0, i = o.height / this.imageInfo.scale * e | 0, r = n + " X " + i;
    ...
    function i(n, i) {
        ...
        if ("file" == n.type) {
            var d = document.createElement("span"), r = document.createElement("input");
        ...
        if (n.type) {
            var d = document.createElement("label"), a = document.createElement("input");
    ...
    function o(o, r, a) {
        ...
        function l() {
            var n = s(), i = n ? n.interactionMode : null;
        ...
        var c = {interactionModes: [
            {name: "默认模式", interactionMode: t.Consts.INTERACTION_MODE_DEFAULT, selected: !0, iconClass: "q-icon toolbar-default"},
            {name: "框选模式", interactionMode: t.Consts.INTERACTION_MODE_SELECTION, iconClass: "q-icon toolbar-rectangle_selection"},
            ...
            {name: "创建连线", interactionMode: t.Consts.INTERACTION_MODE_CREATE_EDGE, iconClass: "q-icon toolbar-edge"},
            {name: "创建L型连线", interactionMode: t.Consts.INTERACTION_MODE_CREATE_SIMPLE_EDGE, iconClass: "q-icon toolbar-edge_VH", edgeType: t.Consts.EDGE_TYPE_VERTICAL_HORIZONTAL},
            {name: "创建多边形", interactionMode: t.Consts.INTERACTION_MODE_CREATE_SHAPE, iconClass: "q-icon toolbar-polygon"},
            {name: "创建线条", interactionMode: t.Consts.INTERACTION_MODE_CREATE_LINE, iconClass: "q-icon toolbar-line"}
        ], search: {name: "Find", placeholder: "Name", iconClass: "q-icon toolbar-search", type: "search", id: "search_input", search: function (t) {
        ...
        }}, exportImage: {name: "导出图片", iconClass: "q-icon toolbar-print", action: function () {
            t.showExportPanel(s())
        }}};
    ...
    }, a = {fillColor: "#EEE", lineWidth: 1, strokeStyle: "#2898E0", padding: {left: 1, top: 1, right: 5, bottom: 5}, shadowColor: "#888", shadowOffsetX: 2, shadowOffsetY: 2, shadowBlur: 3}, s = {};
    ...
    h.prototype = {loadButton: null, imageWidth: 40, imageHeight: 40, loadImageBoxes: function (e) {
        ...
        var i = o("graph-editor__toolbox-buttonBar", n), r = this.loadButton = t.createButton({type: "file", name: getI18NString("Load Images..."), iconClass: "q-icon toolbar-add", action: this.loadImageBoxFile.bind(this)}, this);
        i.appendChild(r);
        var a = [
            {label: "Node", image: "Q-node"},
            {type: "Text", label: "Text", html: '<span style="background-color: #2898E0; color:#FFF; padding: 3px 5px;">' + getI18NString("Text") + "</span>", styles: {"label.background.color": "#2898E0", "label.color": "#FFF", "label.padding": new t.Insets(3, 5)}},
            {type: "Group", label: "Group", image: "Q-group"},
            {label: "SubNetwork", image: "Q-subnetwork", properties: {enableSubNetwork: !0}}
        ], s = [
            {prefix: "Q-", name: "basic.nodes", displayName: getI18NString("Basic Nodes"), images: a},
            {prefix: "Q-", name: "register.images", displayName: getI18NString("Register Images"), images: t.getAllImages()},
            {name: "default.shapes", displayName: getI18NString("Default Shapes"), prefix: "Q-", images: t.Shapes.getAllShapes(this.imageWidth, this.imageHeight)}
        ];
        ...
        var a = e.name, s = e.root, h = e.images, u = e.displayName || a, d = o("group");
        d.id = a, this._groups[a] = d;
        var c = o("group__title", d);
        c.onclick = l, o(null, c, "span", u), o("q-icon group-expand toolbar-expand", c, "span");
        var p = o("group__items", d), f = document.createElement("div");
        if (f.style.clear = "both", d.appendChild(f), !h)return d;
        var g = e.imageWidth || this.imageWidth, m = e.imageHeight || this.imageHeight;
        return r(h, function (r, a) {
            if ("_classPath" != a && "_className" != a) {
                ...
                if (l) {
                    var d;
                    t.isString(l) ? (d = l, !t.hasImage(l) && s && (d = l = s + l)) : d = r.imageName || r.name || a || "drawable-" + this._index++, t.hasImage(d) || t.registerImage(d, l), h = t.createCanvas(g, m, !0), t.drawImage(d, h, n(r.styles)), i(r) ? r = {image: d} : r.image = d, e.size && (r.properties || (r.properties = {}), r.properties.size || (r.properties.size = e.size)), u = d
                } else {
                    if (!r.html)return;
    ...
    function e(e, n, i) {
        var o = document.documentElement, r = new t.Rect(window.pageXOffset, window.pageYOffset, o.clientWidth - 2, o.clientHeight - 2), a = e.offsetWidth, s = e.offsetHeight;
    ...
    r.Separator = "divider", r.prototype = {dom: null, _invalidateFlag: !0, add: function (t) {
        ...
        var i = [];
        if (n) {
            var o = n instanceof t.ShapeNode, r = (n instanceof t.Group, !o && n instanceof t.Node, n instanceof t.Edge);
            if (i.push({text: getI18NString("Rename"), action: function () {
                ...
                i.push({text: getI18NString(a ? "Solid Line" : "Dashed Line"), action: function () {
                    n.setStyle(t.Styles.EDGE_LINE_DASH, a ? null : [5, 3])
                }}), i.push({text: getI18NString("Line Width"), action: function () {
                ...
                }}), i.push({text: getI18NString("Line Color"), action: function () {
            ...
            } else n.parent instanceof t.Group && i.push({text: getI18NString("Out of Group"), action: function () {
                n.parent = null
            }});
            i.push(t.PopupMenu.Separator), i.push({text: getI18NString("Send to Top"), action: function () {
                n.zIndex = 1, e.sendToTop(n), e.invalidate()
            }}), i.push({text: getI18NString("Send to Bottom"), action: function () {
                n.zIndex = -1, e.sendToBottom(n), e.invalidate()
            }}), i.push({text: getI18NString("Reset Layer"), action: function () {
                n.zIndex = 0, e.invalidate()
            }}), i.push(t.PopupMenu.Separator)
        }
        i.push({text: getI18NString("Clear Graph"), action: function () {
            e.clear()
        }}), i.push(t.PopupMenu.Separator), i.push({text: getI18NString("Zoom In"), action: function (t) {
            var n = e.globalToLocal(t);
            e.zoomIn(n.x, n.y, !0)
        }}), i.push({text: getI18NString("Zoom Out"), action: function (t) {
            var n = e.globalToLocal(t);
            e.zoomOut(n.x, n.y, !0)
        }}), i.push({text: getI18NString("1:1"), action: function (t) {
            e.globalToLocal(t);
            e.scale = 1
        }}), i.push(t.PopupMenu.Separator);
        for (var s = e.interactionMode, l = [
            {text: getI18NString("Pan Mode"), value: t.Consts.INTERACTION_MODE_DEFAULT},
            {text: getI18NString("Rectangle Select"), value: t.Consts.INTERACTION_MODE_SELECTION}
    ...
    }}, Object.defineProperties(r.prototype, {items: {get: function () {
        return this._items
    }, set: function (t) {
        this._items = t, this._invalidateFlag = !0
    }}});
    var s = {onstart: function (t, e) {
        e._popupmenu.hide()
    }};
    t.isTouchSupport && (s.onlongpress = function (t, e) {
        o(t, e)
    }), Object.defineProperties(t.Graph.prototype, {popupmenu: {get: function () {
    ...
    function i(t, e) {
        ...
        return n || (n = t._tempName = "class-" + y++), e ? _[n] = {"class": t, properties: {}} : _[n]
    }
    ...
    function u(e, n) {
        this._formItems = [], this.form = t.createElement({"class": "form-horizontal", parent: n, tagName: "form"}), this.graph = e, e.dataPropertyChangeDispatcher.addListener(function (t) {
    ...
    e.prototype = {_getValue: function () {
        ...
        var n = this.property, i = t.createElement({tagName: "input", "class": "form-control", type: n.type, min: n.min, max: n.max, parent: e});
        this.input = i, this.update(), $(i).on("input", function () {
            this.ajdusting || this.setter.call(this.scope, this)
        }.bind(this))
    }}, Object.defineProperties(e.prototype, {value: {get: function () {
        return p(this.input.value, this.property.type)
    }, set: function (t) {
        this.ajdusting = !0, this.setValue(t), this.ajdusting = !1
    }}}), n.prototype = {createHtml: function (e) {
        var n = t.createElement({tagName: "input", "class": "form-control", parent: e});
        t.createElement({tagName: "span", parent: e, "class": "input-group-addon", html: "<i></i>"}), this.input = n, this.update(), $(e).colorpicker().on("changeColor.colorpicker", function () {
            this.ajdusting || this.setter.call(this.scope, this)
        }.bind(this))
    }}, t.extend(n, e);
    var f = [
        {name: "name", displayName: "Name"},
        {style: t.Styles.LABEL_FONT_SIZE, type: "number", displayName: "Font Size"},
        {style: t.Styles.LABEL_COLOR, type: "color", displayName: "Label Color"},
        {style: t.Styles.RENDER_COLOR, type: "color", displayName: "Render Color"}
    ], g = [
        {name: "size", type: "size", displayName: "Size"},
        {name: "location", type: "point", displayName: "Location"},
        {name: "rotate", type: "number", displayName: "Rotate"},
        {style: t.Styles.BORDER, type: "number", displayName: "Border"},
        {style: t.Styles.BORDER_COLOR, type: "color", displayName: "Border Color"}
    ], m = [
        {style: t.Styles.BORDER, display: "none"},
        {style: t.Styles.EDGE_WIDTH, type: "number", displayName: "Edge Width"},
        {style: t.Styles.EDGE_COLOR, type: "color", displayName: "Edge Color"}
    ], v = [
        {name: "size", display: "none"},
        {style: t.Styles.LABEL_SIZE, type: "size", displayName: "Size"},
        {style: t.Styles.RENDER_COLOR, display: "none"},
        {style: t.Styles.BACKGROUND_COLOR, type: "color", displayName: "Background Color"}
    ], _ = {}, y = 0;
    r(t.Element, f, "Element"), r(t.Node, g, "Node"), r(t.Edge, m, "Edge"), r(t.Text, v, "Text"), s.prototype = {contains: function (t, e) {
        var n = o(t, e);
    ...
    u.prototype = {_formItems: null, onValueChange: function (t, e) {
        this.setValue(t, e)
        ...
        var i = t.createElement({"class": "form-group", parent: e}), r = (t.createElement({parent: i, tagName: "label", "class": "col-sm-6 control-label font-small", html: getI18NString(n.displayName || n.name)}), t.createElement({parent: i, "class": "input-group input-group-sm col-sm-6"})), a = b(n, r, function () {
            return this.getValue(n)
        }.bind(this), function (t) {
            this.onValueChange(t.value, n)
        }.bind(this)), s = o(n.name, n.propertyType);
        ...
        var i = t.createElement({"class": "class-group", parent: this.form});
        t.createElement({tagName: "h4", parent: i, html: e});
        for (var e in n)this.createItem(i, n[e])
    }}, Object.defineProperties(u.prototype, {datas: {get: function () {
        return this._datas
    }, set: function (e) {
    ...
    var r = {};
    r[t.Styles.SHAPE_FILL_COLOR] = t.toColor(3435973836), r[t.Styles.SELECTION_COLOR] = "#888", r[t.Styles.SELECTION_SHADOW_BLUR] = 5, r[t.Styles.SELECTION_SHADOW_OFFSET_X] = 2, r[t.Styles.SELECTION_SHADOW_OFFSET_Y] = 2, n.prototype = {_initEditor: function (t, n) {
        ...
        if (t) {
            var e = this.graph.name || "graph", n = this.graph.exportJSON(!0), i = new Blob([n], {type: "text/plain;charset=utf-8"});
            t(i, e + ".json")
        }
        ...
        if (this.options.saveService) {
            ...
            }.bind(this), n.setRequestHeader("Content-Type", "application/json"), n.send(JSON.stringify({name: this.name, json: e}))
        }
        ...
        var o = i("graph-editor__json__buttons", e), r = [
            {name: getI18NString("Update"), action: this.exportJSON.bind(this, !0)},
        ...
        var i = [
            ...
            {iconClass: "q-icon toolbar-upload", name: getI18NString("Load File ..."), action: this.loadJSONFile.bind(this), type: "file"}
        ];
        window.saveAs && i.push({iconClass: "q-icon toolbar-download", name: getI18NString("Download File"), action: this.exportJSONFile.bind(this, window.saveAs)}), this.options.saveService && i.push({iconClass: "q-icon toolbar-save", name: getI18NString("Save"), action: this.save.bind(this)}), t.createToolbar(n, e, {"export": i})
