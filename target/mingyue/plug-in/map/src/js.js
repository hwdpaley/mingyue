/**
 * Created by dujiaoking on 15/7/2.
 */
!function (e, t) {
    ...
    function N(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, o = $t(e), a = "border-box" === Z.css(e, "boxSizing", !1, o);
        if (0 >= i || null == i) {
    ...
    var W = [], $ = W.slice, z = W.concat, X = W.push, U = W.indexOf, G = {}, V = G.toString, Y = G.hasOwnProperty, J = {}, Q = e.document, K = "2.1.3", Z = function (e, t) {
    ...
    var it = function (e) {
        ...
        function x(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, c) {
                var l, f, p, d = 0, h = "0", g = r && [], v = [], y = j, x = r || o && T.find.TAG("*", c), b = B += null == y ? 1 : Math.random() || .1, w = x.length;
        ...
        var b, w, T, E, C, S, N, k, j, L, A, D, P, q, O, H, _, M, F, R = "sizzle" + 1 * new Date, I = e.document, B = 0, W = 0, $ = n(), z = n(), X = n(), U = function (e, t) {
            return e === t && (A = !0), 0
        }, G = 1 << 31, V = {}.hasOwnProperty, Y = [], J = Y.pop, Q = Y.push, K = Y.push, Z = Y.slice, et = function (e, t) {
            for (var n = 0, r = e.length; r > n; n++)if (e[n] === t)return n;
            return -1
        }, tt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", rt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", it = rt.replace("w", "w#"), ot = "\\[" + nt + "*(" + rt + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + it + "))|)" + nt + "*\\]", at = ":(" + rt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", st = new RegExp(nt + "+", "g"), ut = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$", "g"), ct = new RegExp("^" + nt + "*," + nt + "*"), lt = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ft = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]", "g"), pt = new RegExp(at), dt = new RegExp("^" + it + "$"), ht = {
            ID: new RegExp("^#(" + rt + ")"),
            CLASS: new RegExp("^\\.(" + rt + ")"),
    ...
    Z.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, r, i = 0, o = $.call(arguments), a = o.length, s = 1 !== a || e && Z.isFunction(e.promise) ? a : 0, u = 1 === s ? e : Z.Deferred(), c = function (e, n, r) {
                return function (i) {
    ...
    var wt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Tt = ["Top", "Right", "Bottom", "Left"], Et = function (e, t) {
    ...
    var Nt = /^key/, kt = /^(?:mouse|pointer|contextmenu)|click/, jt = /^(?:focusinfocus|focusoutblur)$/, Lt = /^([^.]*)(?:\.(.+)|)$/;
    Z.event = {
        global: {},
        ...
        trigger: function (t, n, r, i) {
            var o, a, s, u, c, l, f, p = [r || Q], d = Y.call(t, "type") ? t.type : t, h = Y.call(t, "namespace") ? t.namespace.split(".") : [];
        ...
        dispatch: function (e) {
            e = Z.event.fix(e);
            var t, n, r, i, o, a = [], s = $.call(arguments), u = (vt.get(this, "events") || {})[e.type] || [], c = Z.event.special[e.type] || {};
    ...
    var At = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Dt = /<([\w:]+)/, Pt = /<|&#?\w+;/, qt = /<(?:script|style|link)/i, Ot = /checked\s*(?:[^=]|=\s*.checked.)/i, Ht = /^$|\/(?:java|ecma)script/i, _t = /^true\/(.*)/, Mt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Ft = {
    ...
    var zt = /^(none|table(?!-c[ea]).+)/, Xt = new RegExp("^(" + wt + ")(.*)$", "i"), Ut = new RegExp("^([+-])=(" + wt + ")", "i"), Gt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    var Jt, Qt, Kt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + wt + ")([a-z%]*)$", "i"), en = /queueHooks$/, tn = [P], nn = {
        "*": [function (e, t) {
    ...
    var pn = /#.*$/, dn = /([?&])_=[^&]*/, hn = /^(.*?):[ \t]*([^\r\n]*)$/gm, gn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, mn = /^(?:GET|HEAD)$/, vn = /^\/\//, yn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, xn = {}, bn = {}, wn = "*/".concat("*"), Tn = e.location.href, En = yn.exec(Tn.toLowerCase()) || [];
    Z.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (e, t) {
            ...
            var r, i, o, a, s, u, c, l, f = Z.ajaxSetup({}, t), p = f.context || f, d = f.context && (p.nodeType || p.jquery) ? Z(p) : Z.event, h = Z.Deferred(), g = Z.Callbacks("once memory"), m = f.statusCode || {}, v = {}, y = {}, x = 0, b = "canceled", w = {
                readyState: 0,
    ...
    o.prototype = {
        _projection: r(), centerElement: function (e) {
            ...
            i.isLine = r, i.setStyle(e.Styles.SHAPE_FILL_COLOR, r ? null : e.toColor(3724541917)), i.setStyle(e.Styles.SHAPE_STROKE, 3), i.setStyle(e.Styles.SHAPE_STROKE_STYLE, "#7e7e7e");
