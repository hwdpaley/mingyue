...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="mutiLangList" title="lang.maintain" actionUrl="mutiLangController.do?datagrid"
   ...
   <t:dgCol title="common.languagekey" field="langKey" query="true"  width="100" align="center"></t:dgCol>
   <t:dgCol title="common.content" field="langContext" query="true"  width="100" align="center"></t:dgCol>
   <t:dgCol title="common.language" field="langCode" width="100" align="center" ></t:dgCol>
