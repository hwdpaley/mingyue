...
<t:datagrid name="userList" title="common.operation" actionUrl="userController.do?datagrid" 
	...
	<t:dgCol title="common.username" sortable="false" field="userName" query="true" width="100" align="center"></t:dgCol>
	...
	<t:dgCol title="common.department" sortable="false" field="userOrgList.tsDepart.departname" query="false" width="100" align="center"></t:dgCol>
    ...
    <t:dgCol title="common.moblePhone" field="mobilePhone" width="100" align="center"></t:dgCol>
	...
	<t:dgCol title="common.status" sortable="true" field="status" replace="common.active_1,common.inactive_0,super.admin_-1" align="center"></t:dgCol>
	...
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="icon-add" url="userController.do?addorupdate" funname="add" height="500"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="icon-edit" url="userController.do?addorupdate" funname="update" height="500"></t:dgToolBar>
