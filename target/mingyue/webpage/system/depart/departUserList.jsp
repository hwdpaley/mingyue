...
<t:datagrid name="departUserList" title="common.operation"
	...
	<t:dgCol title="common.real.name" field="realName" query="true" width="100" align="center"></t:dgCol>
	<t:dgCol title="common.status" sortable="true" field="status" replace="common.active_1,common.inactive_0,super.admin_-1" width="100" align="center"></t:dgCol>
