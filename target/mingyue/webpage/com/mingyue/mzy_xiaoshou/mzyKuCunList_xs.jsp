...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="mzyKuCunList_xs" title="库存管理" actionUrl="mzyKuCunController.do?datagrid" idField="id"
                    fit="true"  checkbox="true">
            <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
            <t:dgCol title="产品名称" field="name" query="true" width="120" align="center"></t:dgCol>
            ...
            <t:dgCol title="金额" field="mzyProductEntity.price" width="50" align="center"></t:dgCol>
            <t:dgCol title="单位" field="mzyProductEntity.dw" width="50" align="center"></t:dgCol>
