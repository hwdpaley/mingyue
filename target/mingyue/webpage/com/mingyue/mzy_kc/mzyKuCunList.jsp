...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:1px;">
        <t:datagrid name="mzyKuCunList" title="库存管理" actionUrl="mzyKuCunController.do?datagrid" idField="id" fit="true"
            ...
            <t:dgCol title="产品名称" field="mzyProductEntity.name" frozenColumn="true" query="true" width="200"
            ...
            <t:dgToolBar title="新库存录入" icon="icon-add" url="mzyKuCunController.do?addorupdate"
                         funname="add"></t:dgToolBar>
            <t:dgToolBar title="库存编辑" icon="icon-edit" url="mzyKuCunController.do?addorupdate"
