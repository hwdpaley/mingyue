					...
					<ul class="nav ace-nav">
						...
						<li class="purple">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								...
								<span class="badge badge-important">180</span>
							</a>
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="plug-in/ace/avatars/profile-pic.jpg" alt="Jason's Photo" />
								<span class="user-info">
									<small><t:mutiLang langKey="common.user"/>:${userName }</small>

                                    <small><t:mutiLang langKey="common.role"/>:${roleName }</small>
				...
				<div class="page-content" style="padding:0px" >
					...
					<div  id="tabs" >
							...
							<div id="tabs-1" style="padding:0px">
						 		<iframe style="width:100%;height:750px;margin:0px;padding:0px" scrolling="auto" frameborder="0" id="center"  src="loginController.do?home" ></iframe>
							</div>
					</div>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder"><t:mutiLang langKey="common.mingyue"/></span>
							 &copy; 2015-2016
						</span>
