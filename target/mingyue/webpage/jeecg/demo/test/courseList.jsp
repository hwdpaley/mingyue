...
<div region="center" style="padding: 1px;"><t:datagrid name="courseList" title="课程" actionUrl="courseController.do?datagrid" idField="id" fit="true" queryMode="group">
	...
	<t:dgCol title="课程名称" field="name" query="true" autocomplete="true" width="100" align="center"></t:dgCol>
	<t:dgCol title="老师姓名" field="teacher_name" query="true" autocomplete="true" width="100" align="center"></t:dgCol>
	<t:dgCol title="老师照片" image="true" imageSize="200,100" field="teacher_pic" width="200" align="center"></t:dgCol>
