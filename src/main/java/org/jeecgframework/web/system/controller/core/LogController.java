...
//        add-end--Author:zhangguoming  Date:20140427 for：添加查询条件  操作时间
     ...
     * @return
     */
    @RequestMapping(params = "jcynetTabs")
    public ModelAndView jcynetTabs(HttpServletRequest request) {
        return new ModelAndView("com/mingyue/jcynet/jcynetTabs");
    }
	/**
	 * 用户浏览器使用统计图
	 * 
     ...
     * @return
     */
    @RequestMapping(params = "netAnsy")
    public ModelAndView netAnsy(String reportType, HttpServletRequest request) {
        request.setAttribute("reportType", reportType);
        if("pie".equals(reportType)){
            return new ModelAndView("com/mingyue/jcynet/userBroswerPie");
        }else if("line".equals(reportType)) {
            return new ModelAndView("com/mingyue/jcynet/userBroswerLine");
        }else if("column".equals(reportType)) {
            return new ModelAndView("com/mingyue/jcynet/userBroswer");
        }else if("grid".equals(reportType)) {
            return new ModelAndView("com/mingyue/jcynet/jcynetGrid");
        }
        return new ModelAndView("com/mingyue/jcynet/userBroswer");
    }
	/**
     ...
     * @return
     */
//    @RequestMapping(params = "getNetBar")
//    @ResponseBody
//    public List<Highchart> getNetBar(HttpServletRequest request,String reportType, HttpServletResponse response) {
//        List<Highchart> list = new ArrayList<Highchart>();
//        Highchart hc = new Highchart();
//        StringBuffer sb = new StringBuffer();
//        sb.append("SELECT broswer ,count(broswer) FROM TSLog group by broswer");
