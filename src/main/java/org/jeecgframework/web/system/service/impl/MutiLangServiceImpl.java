...
public class MutiLangServiceImpl extends CommonServiceImpl implements MutiLangServiceI {
    ...
    public String getIdNum(){
        MutiLangEntity mutiLangEntity=findUniqueByProperty(MutiLangEntity.class,"langKey","mingyue.idDanNum");
        String idnum=String.valueOf(Integer.parseInt(mutiLangEntity.getLangContext()));
        mutiLangEntity.setLangContext(String.valueOf(Integer.parseInt(idnum)+1));
        saveOrUpdate(mutiLangEntity);
        return idnum;
    }
    public String getsqbhIdNum(){
        MutiLangEntity mutiLangEntity=findUniqueByProperty(MutiLangEntity.class,"langKey","mingyue.sqbhId");
        String idnum=String.valueOf(Integer.parseInt(mutiLangEntity.getLangContext()));
        mutiLangEntity.setLangContext(String.valueOf(Integer.parseInt(idnum)+1));
        saveOrUpdate(mutiLangEntity);
        return idnum;
    ...
    public String getMapLang(String langKey) {
        String langContext = MutiLangEntity.mutiLangMap.get(langKey + "_" + "zh-cn");
        return langContext;
    }
    /**
