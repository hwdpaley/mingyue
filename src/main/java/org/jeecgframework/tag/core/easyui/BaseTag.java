...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js"+("metro".equals(cssTheme)?"?skin=metro":"")+"\"></script>");
            ...
            if (oConvertUtils.isIn("Map", types)) {
                sb.append("<script type=\"text/javascript\" src=\"plug-in/qunee/js/qunee-min.js\"></script>");
                sb.append("<script type=\"text/javascript\" src=\"plug-in/qunee/js/common.js\"></script>");
                sb.append("<script type=\"text/javascript\" src=\"plug-in/map/src/js.js\"></script>");
            }
            if (oConvertUtils.isIn("Highcharts", types)) {
                sb.append("<script type=\"text/javascript\" src=\"plug-in/Highcharts-2.2.5/js/highcharts.src.js\"></script>");
                sb.append("<script type=\"text/javascript\" src=\"plug-in/Highcharts-2.2.5/js/modules/exporting.src.js\"></script>");
            }
            if (oConvertUtils.isIn("Echarts", types)) {
                sb.append("<script type=\"text/javascript\" src=\"plug-in/echarts/source/echarts.js\"></script>");
//                sb.append("<script type=\"text/javascript\" src=\"plug-in/echarts/dist/chart/bar.js\"></script>");
//                sb.append("<script type=\"text/javascript\" src=\"plug-in/echarts/dist/chart/pie.js\"></script>");
//                sb.append("<script type=\"text/javascript\" src=\"plug-in/echarts/dist/chart/line.js\"></script>");
            }
            if (oConvertUtils.isIn("Zrender", types)) {
                sb.append("<script type=\"text/javascript\" src=\"plug-in/zrender/doc/asset/js/esl/esl.js\"></script>");
            }
            if (oConvertUtils.isIn("Ck", types)) {
                sb.append("<script type=\"text/javascript\" src=\"plug-in/ckeditor/ckeditor.js\"></script>");
                sb.append("<script type=\"text/javascript\" src=\"plug-in/ckfinder/ckfinder.js\"></script>");
            }
            if (oConvertUtils.isIn("Editor", types)) {
                sb.append("<link rel=\"stylesheet\" href=\"plug-in/qunee/css/bootstrap.css\" type=\"text/css\"></link>");
                sb.append("<link rel=\"stylesheet\" href=\"plug-in/qunee/css/bootstrap-colorpicker.min.css\"></link>");
                sb.append("<link rel=\"stylesheet\" href=\"plug-in/qunee/css/geditor.css\" type=\"text/css\"></link>");
                sb.append("<link rel=\"stylesheet\" href=\"plug-in/qunee/css/main.css\" type=\"text/css\"></link>");
            }
