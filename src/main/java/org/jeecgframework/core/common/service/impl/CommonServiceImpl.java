...
public class CommonServiceImpl implements CommonService {
    ...
    public List<McuiTreeGrid> mcuiTreegrid(List all, McuiTreeGridModel mcuiTreeGridModel) {
        return commonDao.mcuiTreegrid(all, mcuiTreeGridModel);
    }
    ...
    public void callableStatementByName(String hql) {
        this.commonDao.callableStatementByName(hql);
    }
}
