...
<t:datagrid name="roleList" title="common.role.list" actionUrl="roleController.do?roleGrid"
	...
	<t:dgCol title="common.role.code" field="roleCode" width="100" align="center"></t:dgCol>
	<t:dgCol title="common.role.name" field="roleName" query="true" width="100" align="center"></t:dgCol>
