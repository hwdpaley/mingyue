...
<div region="center" style="padding: 1px;">
	...
	<t:dgCol title="common.taskid" field="taskId" width="150" align="center"></t:dgCol>
	<t:dgCol title="common.task.desc" field="taskDescribe" width="150" align="center"></t:dgCol>
	<t:dgCol title="cron.expression" field="cronExpression" width="50" align="center"></t:dgCol>
	<t:dgCol title="common.iseffect" field="isEffect" replace="未生效_0,已生效_1" width="50" align="center"></t:dgCol>
	<t:dgCol title="running.state" field="isStart" replace="停止_0,运行_1" width="50" align="center"></t:dgCol>
