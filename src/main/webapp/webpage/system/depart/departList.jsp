...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding: 1px;">
        <t:datagrid name="departList" title="common.department.list"
                    ...
                    treegrid="true" idField="departid" pagination="true" fitColumns="false">
            <t:dgCol title="common.id" field="id" treefield="id" hidden="true"></t:dgCol>
            <t:dgCol title="common.department.name" field="departname" treefield="text" frozenColumn="true" width="120" align="left"></t:dgCol>
            <%--<t:dgCol title="position.desc" field="description" treefield="src" width="200" align="center"></t:dgCol>--%>
            <t:dgCol title="店铺地址" field="address" treefield="address" width="120" align="center"></t:dgCol>
            <t:dgCol title="开业时间" field="openDate" treefield="openDate" formatter="yyyy-MM-dd" width="120" align="center"></t:dgCol>
            <t:dgCol title="店铺电话" field="tel" treefield="tel" width="120" align="center"></t:dgCol>
            <t:dgCol title="店长" field="mainName" treefield="mainName" width="100" align="center"></t:dgCol>
            <t:dgCol title="单号编码" field="departCode" treefield="departCode" width="100" align="center"></t:dgCol>
            <t:dgCol title="会员编码" field="customCode" treefield="customCode" width="150" align="center"></t:dgCol>
            <%--<t:dgCol title="common.org.code" field="orgCode" treefield="fieldMap.orgCode" width="100" align="center"></t:dgCol>--%>
            <%--<t:dgCol title="common.org.type" field="orgType" dictionary="orgtype" treefield="fieldMap.orgType" width="100" align="center"></t:dgCol>--%>
            <t:dgCol title="common.operation" field="opt" width="300" align="center"></t:dgCol>
            <c:if test="${isAdmin >0 }">
        ...
        <div id="departListtb" style="padding: 3px; height: 25px">
            <div style="float: left;">
                ...
                <a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit"  onclick="update('<t:mutiLang langKey="common.edit.param" langArg="common.department"/>','departController.do?update','departList',700,600)"><t:mutiLang langKey="common.edit.param" langArg="common.department"/></a>
            </div>
        </div>
    </div>
</div>
...
<!--
    ...
    function addOrg() {
        ...
        add('<t:mutiLang langKey="common.add.param" langArg="common.department"/>', url, "departList",700,600);
    }
