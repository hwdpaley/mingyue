...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveDepart">
	...
	<fieldset class="step">
        ...
        <div class="form">
            <label class="Validform_label"> 店铺地址: </label>
            <input name="address" class="inputxt" value="${depart.address }">
        </div>
        <div class="form">
            <label class="Validform_label"> 店铺电话: </label>
            <input name="tel" class="inputxt" value="${depart.tel }">
        </div>
        <div class="form">
            <label class="Validform_label"> 店长: </label>
            <input name="mainName" class="inputxt" value="${depart.mainName }">
        </div>
        <div class="form">
            <label class="Validform_label"> 开业时间: </label>
            <input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width: 200px" id="openDate"
                   name="openDate" ignore="ignore"
                   value="<fmt:formatDate value='${depart.openDate}' type="date" pattern="yyyy-MM-dd"/>">
        ...
        <div class="form">
            <label class="Validform_label"> 单号编码: </label>
            <input name="departCode" class="inputxt" value="${depart.departCode }">
        </div>
        <div class="form">
            <label class="Validform_label"> 会员编码: </label>
            <input name="customCode" class="inputxt" value="${depart.customCode }">
        </div>
	</fieldset>
</t:formvalid>
</body>
