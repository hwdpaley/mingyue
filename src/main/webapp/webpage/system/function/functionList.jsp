...
<div region="center" style="padding: 1px;">
    <t:datagrid name="functionList" title="menu.manage"  actionUrl="functionController.do?functionGrid" idField="id" treegrid="true" pagination="true">
        <t:dgCol title="common.id" field="id" treefield="id" hidden="true"></t:dgCol>
        <t:dgCol title="menu.name" field="functionName" treefield="text" width="100" align="left"></t:dgCol>
        <t:dgCol title="common.icon" field="TSIcon_iconPath" treefield="code" imageSize="60,60" align="center"></t:dgCol>
        ...
        <t:dgCol title="menu.order" field="functionOrder" treefield="order" width="50" align="center"></t:dgCol>
        <t:dgCol title="common.operation" field="opt"  width="200" align="center"></t:dgCol>
