...
<t:datagrid title="log.manage" name="logList" actionUrl="logController.do?datagrid" idField="id" sortName="operatetime" sortOrder="desc" pageSize="100" extendParams="view:scrollview,">
	<t:dgCol title="log.level" field="loglevel" hidden="true"></t:dgCol>
	<t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
	<t:dgCol title="log.content" field="logcontent" width="300" align="center"></t:dgCol>
    <t:dgCol title="common.operateName" field="TSUser.realName" width="100" align="center"></t:dgCol>
	<t:dgCol title="operate.ip" field="note" width="100" align="center"></t:dgCol>
	<t:dgCol title="common.moblePhone" field="TSUser.mobilePhone" width="100" align="center"></t:dgCol>
	<t:dgCol title="operate.time" field="operatetime" formatter="yyyy-MM-dd hh:mm:ss" width="200" align="center"></t:dgCol>
    <t:dgCol title="common.browser.recommend" field="broswer" width="100" align="center"></t:dgCol>
