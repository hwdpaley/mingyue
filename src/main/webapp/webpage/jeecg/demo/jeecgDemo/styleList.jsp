...
<div class="main">
	<form id="mutiLangListtb">
		...
		<div class="shadowBoxWhite tableDiv">
			<table class="easyui-datagrid"
				data-options="striped:true,url:'mutiLangController.do?datagrid&field=id,langKey,langContext,langCode',pageList: [20,40,60,100],pageSize:20,fitColumns:'true',queryParams:{'complete':''}"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'langKey',width:150,align:'center'" formatter="forsn" >语言Key</th>
						<th data-options="field:'langContext',width:100,sortable:'true',align:'center'"   >内容</th>
						<th data-options="field:'langCode',width:100,sortable:'true',align:'center'" formatter="forlang" >语言</th>
						<th data-options="field:'opt',width:100,align:'center'" formatter="formatAction" >操作</th>
					</tr>
				</thead>
			</table>
		</div>
...
function formatAction(value,row,index){
    ...
    var val1="<a class='delete' title='查看' href='#' onclick=\"add('查看','mutiLangController.do?addorupdate&id="+row.id+"','mutiLangList',null,null)\" ></a>";
