            ...
            $.ajax({
                ...
                success: function (jsondata) {
                    ...
                    chart = new Highcharts.Chart({
                        ...
                        xAxis: {
                            categories: [ '1班', '2班', '3班', '4班', '5班','6班','7班']
                        },
                        tooltip: {
                            shadow: false,
...
<div region="center" style="width:1100px;height:280px">
    <%--<div region="center" style="padding: 1px;">--%>
        <t:datagrid name="studentStatisticList" title="class.count.statistics"
                    actionUrl="reportDemoController.do?listAllStatisticByJdbc" idField="id" fit="true">
            <t:dgCol title="common.code" field="id" hidden="true"></t:dgCol>
            <t:dgCol title="lang.class" field="classname" width="130" align="center"></t:dgCol>
            <t:dgCol title="number.ofpeople" field="personcount" width="130" align="center"></t:dgCol>
