...
<div region="north" border="false" title=""
     style="BACKGROUND:#A8D7E9; height: 80px; padding: 1px; overflow: hidden;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">

        <tr>
            <td colspan="2" align="left" style="height: 80px;vertical-align: text-bottom">
                <ul class="shortcut">
                    <!-- 动态生成并赋值过来 -->
                </ul>
            </td>
            ...
            <%--&lt;%&ndash;<img  height="96px"  width="50%" src="plug-in/login/images/navPic.jpg" >&ndash;%&gt;--%>
            <%--&lt;%&ndash;<img src="plug-in/login/images/logo.jpg">&ndash;%&gt;--%>
            <%--<!----%>
            <%--<img src="plug-in/login/images/toplogo.png" width="550" height="52" alt="">-->--%>
            <%--&lt;%&ndash;<div style="position: absolute; top: 75px; left: 33px;">JEECG Framework <span style="letter-spacing: -1px;">-3.5.2</span></div>&ndash;%&gt;--%>
            <%--</td>--%>
                    ...
                    <tr style="height: 25px;" align="right">
                        <td style="" colspan="2">
                            <div style="float: right;">
                                <%--background: url(plug-in/login/images/top_bg.jpg) no-repeat right center;--%>
                                ...
                                <div style="float: left; margin-left: 18px;">
                                    <div style="right: 0px; bottom: 0px;">
                                        ...
                                        <a href="javascript:void(0);" class="easyui-menubutton"
                                           ...
                                           iconCls="icon-exit" style="color: #FFFFFF">
                                            <t:mutiLang langKey="common.logout"/>
                                        </a>
                                    </div>
                                    <div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
                                        <div style="font-size: 14px" onclick="openwindow('<t:mutiLang
                                                langKey="common.profile"/>','userController.do?userinfo')">
                                            <t:mutiLang langKey="common.profile"/>
                                        </div>
                                        <div class="menu-sep"></div>
                                        <div style="font-size: 14px" onclick="add('<t:mutiLang
                                        ...
                                        <div class="menu-sep"></div>
                                        <div style="font-size: 14px" onclick="clearLocalstorage()">
                                            <t:mutiLang langKey="common.clear.localstorage"/>
                                        </div>
                                    </div>
                                    <div id="layout_north_zxMenu" style="width: 100px; display: none;">
                                        <div style="font-size: 14px"
                                             onclick="exit('loginController.do?logout','<t:mutiLang
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            ...
            <a href="#" title="mingyue -3.5.2">2015-2016</a>
        </span>
    </div>
</div>
