...
<t:base type="jquery,easyui,Zrender"></t:base>
<%--<script type="text/javascript" src="plug-in/zrender/doc/asset/js/esl/esl.js"></script>--%>
...
//        var fileLocation = 'plug-in/zrender/src';
//
//
//
//
...
<%--<span id="containerPie" style="float: right; width: 500px; height: 500px"></span>--%>
<%--<span id="containerCol" style="float: left; width: 500px; height: 500px"></span>--%>
