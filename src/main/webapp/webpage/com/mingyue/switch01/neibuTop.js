...
function initDatas() {//"/bulidTreeGraph?name="+"主楼"
    ...
    Q.loadJSON("/switch01Controller.do?switchTree", function (json) {
...
var timer = setTimeout(function A() {
    ...
    Q.loadJSON("/switch01Controller.do?getState" , function (json) {
        if(json.success){
...
//        //    return;
//        //}
//        Q.loadJSON("/getElementByIp?getState" , function (json) {
//            if (json.success) {
//                var alarmSeverity = AlarmSeverity.random;
