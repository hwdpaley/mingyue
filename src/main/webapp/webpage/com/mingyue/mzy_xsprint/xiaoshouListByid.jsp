...
<t:datagrid name="mzy_xiaoshouList" title="销售清单" actionUrl="mzy_xsprintController.do?xsdatagrid&xsprintId=${xsprintId}"
            idField="id"
            fit="true">
    ...
    <%--<t:dgToolBar title="销售录入" icon="icon-add" url="mzy_xiaoshouController.do?addorupdate&xsprintId=${xsprintId}"--%>
                 <%--funname="add"></t:dgToolBar>--%>
    <%--<t:dgToolBar title="销售编辑" icon="icon-edit" url="mzy_xiaoshouController.do?addorupdate&xsprintId=${xsprintId}"--%>
