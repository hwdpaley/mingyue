...
!function (n) {
    ...
    function a(n, e, t) {
        T[n] || (T[n] = {id: n, depsDec: e, deps: e || ["require", "exports", "module"], factoryDeps: [], factory: t, exports: {}, config: o, state: z, require: w(n), depMs: [], depMkv: {}, depRs: [], depPMs: []})
    }
    ...
    function u(n) {
        ...
        if (e && !l(n, B)) {
            ...
            $(t, function (t, r) {
                ...
                c && !P[c] ? (f.res && (u = {id: t, mod: c, res: f.res}, F[c] = 1, e.depPMs.push(c), e.depRs.push(u)), a = e.depMkv[c], a || (a = {id: f.mod, absId: c, hard: i > r}, e.depMs.push(a), e.depMkv[c] = a, o.push(c))) : a = {absId: c}, i > r && e.factoryDeps.push(u || a)
            }), e.state = B, s(n), m(o)
        }
    }
        ...
        function t() {
            if (!r && i.state === L) {
                ...
                if ($(i.factoryDeps, function (n) {
                    ...
                    try {
                        var a = p(o, {require: i.require, exports: i.exports, module: i}), u = i.factory, f = "function" == typeof u ? u.apply(n, a) : u;
    ...
    function k() {
        C.baseUrl = C.baseUrl.replace(/\/$/, "") + "/", J = M(C.paths), V = M(C.map, 1), $(V, function (n) {
            ...
            var e = n;
            "string" == typeof n && (e = {name: n.split("/")[0], location: n, main: "main"}), e.location = e.location || e.name, e.main = (e.main || "main").replace(/\.js$/i, ""), e.reg = O(e.name), K.push(e)
    ...
    var D, T = {}, F = {}, z = 1, B = 2, L = 3, N = 4, P = {require: e, exports: 1, module: 1}, _ = w(), C = {baseUrl: "./", paths: {}, config: {}, map: {}, packages: [], waitSeconds: 0, noRequests: {}, urlArgs: {}};
