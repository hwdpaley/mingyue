...
// 按日期变更登录界面 by dongboh
function changeUI() {
    var dateTime = new Date();
    var dd = dateTime.getSeconds();
    dd = dd % 10;
    var bg;
    if(dd ==0)
        bg="plug-in/sliding/images/bg/blue.jpg";
    else if(dd ==1)
        bg="plug-in/sliding/images/bg/blue1.jpg";
    else if(dd ==2)
        bg="plug-in/sliding/images/bg/7_7.jpg";
    else if(dd ==3)
        bg="plug-in/sliding/images/bg/blue_glow.jpg";
    else if(dd ==4)
        bg="plug-in/sliding/images/bg/cloud.jpg";
    else if(dd ==5)
        bg="plug-in/sliding/images/bg/dandelionDream.jpg";
    else if(dd ==6)
        bg="plug-in/sliding/images/bg/dreamSky.jpg";
    else if(dd ==7)
        bg="plug-in/sliding/images/bg/grass.jpg";
    else if(dd ==8)
        bg="plug-in/sliding/images/bg/gravity.jpg";
    else if(dd ==9)
        bg="plug-in/sliding/images/bg/christmas.jpg";
    else
        $("#Layer1").remove();
    $("#backImage").attr("src",bg);
}
...
function Login(orgId) {
	...
	$.ajax({
		...
		success : function(data) {
			...
			if (d.success) {
				loginsuccess();
//                setTimeout("window.location.href='"+actionurl+"'", 100);
